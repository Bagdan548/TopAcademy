...
print("Сумму элементов, находящихся между первым и последним положительными элементами: ", sum(mas[min(a:= [i for i in range(len(mas)) if mas[i] > 0], default=0):max(a,default=-1) + 1]))